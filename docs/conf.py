...
# copyright = "2017, Nyimbi Odero".format(now.year)
...
author = {{ '{0!r}'.format(cookiecutter.author_name) }}
copyright = '{0}, {1}'.format(year, author)
version = release = {{ '{0!r}'.format(cookiecutter.project_version) }}
...
texinfo_documents = [
    ('index', 'Cookiecutter Django', 'Cookiecutter Django documentation',
     'Nyimbi Odero', 'Cookiecutter Django',
